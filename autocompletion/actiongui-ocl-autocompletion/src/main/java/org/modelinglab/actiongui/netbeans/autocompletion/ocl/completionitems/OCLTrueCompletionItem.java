 ...
 */
public class OCLTrueCompletionItem extends OCLCompletionItem{
    
    private final BooleanValue trueValue;
    
    public OCLTrueCompletionItem(String prefix, int caretOffset) {
        super(prefix, caretOffset, 0); 
        this.trueValue = BooleanValue.TRUE;
